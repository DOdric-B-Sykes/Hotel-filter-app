...
// 1. `display`: This property represents the human-readable display text for the filtering option (e.g., "Free Cancellation", "Breakfast Included"). 2. `key`: This property represents the key that corresponds to the filtering option in the data (e.g., "hasFreeCancellation", "includesBreakfast")
